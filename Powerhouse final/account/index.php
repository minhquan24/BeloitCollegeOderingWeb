    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Items</a>
            </li>
                <li class="no-padding">
            ...
            <li class="bold"><a href="check_out.php" class="waves-effect waves-cyan"><i class="mdi-navigation-check"></i> Check Out</a>
            </li>
