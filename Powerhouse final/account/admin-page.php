        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1">The Powerhouse</a> <span class="logo-text">The Powerhouse</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Items Menu</a>
            </li>
                <li class="no-padding">
                 ...
                 <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Reports</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="all-tickets.php">All Reports</a>
                                </li>
								<?php
            ...
            <div class="row">
              ...
              <div>
				...
				while($row = mysqli_fetch_array($result))
				{
                    ...
                    echo '<td><div class="input-field col s12 "><label for="'.$row["id"].'_quantity">Quantity</label>';
                    echo '<input value="'.$row["quantity"].'" id="'.$row["id"].'_price" name="'.$row['id'].'_quantity" type="text" data-error=".errorTxt'.$row["id"].'"><div class="errorTxt'.$row["id"].'"></div></td>';
...
<table>
				...
				<?php
                    ...
                    echo '<td><div class="input-field col s12 "><label for="quantity" class=""></label>';
                    echo '<input id="quantity" name="quantity" type="text" data-error=".errorTxt02"><div class="errorTxt02"></div></td>';
				?>
                    </tbody>
</table>
              </div>
    ...
    $("#formValidate").validate({
        ...
        messages: {
			...
			{  
                ...
                min: "Minimum item quantity is 1"
                },';
			}
		echo '},';
		?>
