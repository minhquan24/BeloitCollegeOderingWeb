    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="wallet_info.php" class="waves-effect waves-cyan"><i class="mdi-action-wallet-travel"></i>Wallet info</a>
            </li>
        </ul>
      ...
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Choose what you want to check out</p>
					...
					while($row = mysqli_fetch_array($sql))
					{
						...
						while($row1 = mysqli_fetch_array($sql1))
						{
							...
							$id = $row1['order_id'];
								...
								echo '<form action="routers/check-out-order.php" method="post">
                                        <input type="hidden" value="'.$id.'" name="id">
										<input type="hidden" value="Cancelled by Student" name="status">
										<input type="hidden" value="'.$row['payment_type'].'" name="payment_type">											
										<button class="btn waves-effect waves-light right submit" type="submit" name="action">Check Out
