    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Items Menu</a>
            </li>
                <li class="no-padding">
					...
					while($row = mysqli_fetch_array($sql))
					{
						...
						echo '<li class="collection-item avatar">
							  ...
							  <form method="post" action="routers/edit-orders.php">
								...
								<option value="Checked out by admin" '.($status=='Checked out by admin' ? 'selected' : '').'>Checked out by admin</option>
								<option value="Not Available" '.($status=='Not Available' ? 'selected' : '').'>Not Available</option>
								<option value="In Maintainance" '.($status=='In Maintainance' ? 'selected' : '').'>In Maintainance</option>
								</select>
							  ').'</p>
